const MaintenanceHeaderDetail = ({ imageSrc, sectionType }) => {
  ...
  const renderSection = (sectionType) => {
    switch (sectionType) {
      ...
      default:
        return (
          <div className="ui very padded segment">
           <h1>Maintenance Request Tracking</h1>
            <div className="ui four column grid">
              <div className="row">
                <p className="column"><strong>Request Status:</strong> </p>
                <p className="column"><strong>Parts Availability:</strong> </p>
                <p className="column"><strong>Equipment Condition:</strong> </p>
                <p className="column"><strong>Inspection Notes:</strong></p>
